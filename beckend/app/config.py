...
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("MERIPDF_TOKEN_MINUTES") or os.getenv("DOCINTEL_TOKEN_MINUTES", "10080"))  # 7 days
...
SMTP_PORT = int(os.getenv("MERIPDF_SMTP_PORT") or os.getenv("DOCINTEL_SMTP_PORT", "587"))
...
FREE_ANONYMOUS_PDF_OPS_PER_DAY = int(os.getenv("MERIPDF_FREE_PDF_OPS_PER_DAY") or os.getenv("DOCINTEL_FREE_PDF_OPS_PER_DAY", "5"))
