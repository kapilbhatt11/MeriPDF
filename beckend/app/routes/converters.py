...
async def pdf_to_excel(
    ...
    try:
        ...
        def clean_hindi_text(text: str) -> str:
            ...
            # 2. Contextual rules & Devanagari ligature repairs

            import re

            text = re.sub(r"पत्रत्र+", "पत्र", text)

            text = re.sub(r"तिथिि+", "तिथि", text)

            text = re.sub(r"भर्तीर्ती+", "भर्ती", text)

            text = re.sub(r"प्रप्रथम+", "प्रथम", text)

            text = re.sub(r"द्वितीयीय+", "द्वितीय", text)



            text = re.sub(r"आवेदन[- ]प(?!त्र)", "आवेदन-पत्र", text)

            text = re.sub(r"परीा(?!क्षा)", "परीक्षा", text)

            text = re.sub(r"भत(?!ी|र्ती)", "भर्ती", text)

            text = re.sub(r"िनयम(?!पुिस्तका|पुस्तिका)", "नियम", text)

            text = re.sub(r"पुिस्तका", "पुस्तिका", text)

            text = re.sub(r"अितिरक्त", "अतिरिक्त", text)

            text = re.sub(r"पिरचय", "परिचय", text)

            text = re.sub(r"िमनट", "मिनट", text)

            text = re.sub(r"िनवासी", "निवासी", text)

            text = re.sub(r"संिवदा", "संविदा", text)

            text = re.sub(r"अिनवाय", "अनिवार्य", text)

            text = re.sub(r"आयोिजत", "आयोजित", text)

            text = re.sub(r"छायाप्रित", "छायाप्रति", text)
            ...
            # Word hacks & cleaner normalizations for Devanagari extraction
            ...
            word_hacks = {
                ...
                # Round 7 Devanagari 9-Type Perfection Fixes
                ...
                "परीा शु क": "परीक्षा शुल्क",

                "परीा दनाकं": "परीक्षा दिनांक",

                "परीा दनांक": "परीक्षा दिनांक",
                ...
                "प्रन्टिआउट": "प्रिंटआउट",

                "पुलसि": "पुलिस",

                "नम्नलिखतिि": "निम्नलिखित",
