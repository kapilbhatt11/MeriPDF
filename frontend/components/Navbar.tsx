...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-sm">
      ...
      {/* Mobile Drawer menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute left-0 right-0 top-16 bg-white p-6 flex flex-col gap-6 shadow-2xl border-t border-slate-200 z-[9999] max-h-[calc(100vh-4rem)] overflow-y-auto select-none border-b border-slate-200/50 animate-in slide-in-from-top duration-250">
