...
import { Loader2, FileDown, X, HelpCircle, UploadCloud, Plus, RotateCw, File as FileIcon, Presentation } from "lucide-react";
...
export default function PptToPdf() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      setDownloadUrl(null);
      validSlides.forEach(fetchThumbnail);
    }
  };
                  ...
                  >
                    <div className="w-full aspect-[4/3] bg-gradient-to-tr from-orange-50 to-red-50/40 rounded-xl overflow-hidden flex items-center justify-center border border-slate-200 relative group cursor-grab">
                      ...
                      <button
                        ...
                        className="absolute bottom-2 right-2 bg-orange-600 hover:bg-orange-700 text-white p-1 rounded-full shadow-md transition hover:scale-110 active:scale-90 z-20 cursor-pointer"
                        title="Rotate Slide"
                      >
